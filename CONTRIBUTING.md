...
- Within each category the five most-starred projects are shown first, each with its star count, and the rest are folded under a collapsed "More" block. Stars decide the order, humans decide who is on the list at all.
