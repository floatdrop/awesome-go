...
- <img src="badges/stars/pion--opus.svg" alt="561 stars" align="absmiddle"> [opus](https://github.com/pion/opus) - Implementation of the Opus audio codec per RFC 6716, with bitstream internals exported for analysis.
...
- <img src="badges/stars/janosmiko--lfk.svg" alt="901 stars" align="absmiddle"> [lfk](https://github.com/janosmiko/lfk) - Kubernetes TUI with yazi-style Miller columns over the owner hierarchy, plus Helm and trivy.
