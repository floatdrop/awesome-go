...
99 projects in 19 categories. Every entry is added by a human through a pull request and checked against the [entry rules](CONTRIBUTING.md#entry-rules) by CI. Within each category the 3 most-starred projects take the podium and the rest are listed as contenders. Archived repositories are removed automatically. Stars were last refreshed on 2026-09-12.
